...
document.getElementById('spinButton').addEventListener('click', () => {
    if (spinning) return;
    const lastSpin = localStorage.getItem('1530b6d9-7f1a-4f0a-8e7d-0d7e4b1a2f3c');
    ...
    function animate(timestamp) {
        ...
        if (progress < 1) {
            ...
            let totalWeight = 0;  // Исправлено: инициализация переменной
            prizes.forEach(prize => totalWeight += prize.weight);  // Исправлено: корректное вычисление totalWeight
